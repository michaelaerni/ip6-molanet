...
def create_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser("All enhancements training script")
...
if __name__ == "__main__":
    ...
    if args.logsubdir and args.restore is None:
        now = datetime.now()
        subdirname = f"run_{now.month:02}{now.day:02}_{now.hour:02}{now.minute:02}_all_enhancements"
